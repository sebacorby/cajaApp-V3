...
| `CardInstallmentProjection` | Future installment obligations derived from accepted statements | id, statementRowId, originalAmount, remainingInstallments, remainingAmount |
