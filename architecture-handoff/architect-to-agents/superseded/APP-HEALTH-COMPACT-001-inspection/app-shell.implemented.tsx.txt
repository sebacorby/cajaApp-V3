...
import { FinancialHealthCompactProvider } from "@/components/finance/financial-health/financial-health-compact-provider";
...
export function AppShell({ children }: AppShellProps) {
  ...
  const activeLabel =
    NAV_ITEMS.find((item) => item.id === section)?.description ?? "CajaApp";

  return (
    <FinancialHealthCompactProvider>
