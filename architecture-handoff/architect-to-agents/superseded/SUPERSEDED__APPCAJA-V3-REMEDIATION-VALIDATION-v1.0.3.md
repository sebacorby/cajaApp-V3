# APPCAJA-V3-REMEDIATION-VALIDATION-v1.0.3
...
- Carpeta única de entrega: `I:\cajaApp-V3\architecture-handoff\agents-to-architect\pending-validation\APPCAJA-V3-REMEDIATION-VALIDATION-evidence-v1.0.3`.
...
7. Crear una copia nueva de campaña dentro de la carpeta de evidencia o en `%TEMP%\cajaapp-sqlite-backups`, con nombre inequívoco `PRE-v1.0.3`.
...
- no debe quedar ningún registro `UAT-v1.0.3-`;
...
4. Restaurar la copia limpia `PRE-v1.0.3` sobre `prisma\dev.db`.
...
- campaña `APPCAJA-V3-REMEDIATION-VALIDATION-v1.0.3`;
- root exacto;
...
2. Confirmar que toda la evidencia está dentro de la carpeta `v1.0.3`.
...
Si la evidencia `v1.0.3` es completa y el arquitecto acepta el `PASS`, quedará habilitada la emisión de:
