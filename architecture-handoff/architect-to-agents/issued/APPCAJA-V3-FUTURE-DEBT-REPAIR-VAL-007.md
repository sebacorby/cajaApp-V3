...
- Windows x64.
- **Node.js v24.18.0**.
- Bloquear si `node --version` no devuelve exactamente `v24.18.0`.
- **Node 22 queda supersedido y no debe exigirse.**
...
- E7: ejecución oficial con Node.js v24.18.0.
...
El valor de `node --version` debe ser `v24.18.0`.
...
Si `11436` o `11437` ya tiene un proceso LISTENING, identificar PID. Si corresponde a una instancia vieja de CajaApp, utilizar exclusivamente:
...
Sólo si todos los gates técnicos pasan bajo **Node.js v24.18.0**.
