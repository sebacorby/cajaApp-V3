# 01 - Environment — v1.0.6 Salary Receipt Final E2E Closure
...
| workspace/frontend/tests/salary-receipts.real.spec.ts | B21A38CF96457A7882E2834341E15A0AE81A9F6EAA9D6AEDE06C96496E4A7C3C |
...
## SQLite Backup
Path: C:\Users\javie\AppData\Local\Temp\cajaapp-salary-receipt-final-e2e-closure-v1.0.6\dev.db.backup
...
1. page.getByDisplayValue(/Sueldo b[aá]sico/i) EXISTS in spec ✅
2. preview.getByDisplayValue NOT exists ✅
3. No toContainText(/Sueldo.*/) at line 86 ✅
4. No page.route ✅
5. No test.skip ✅
6. No test.fixme ✅
7. Uses salary-receipt.sanitized.base.pdf ✅
8. Creates byte-distinct copy per execution ✅
9. Cleanup via /reverse in finally ✅