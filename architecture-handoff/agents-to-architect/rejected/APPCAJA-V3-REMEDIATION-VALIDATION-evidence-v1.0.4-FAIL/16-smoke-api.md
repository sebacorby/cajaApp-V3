...
```json
{"ok":false,"error":"backend build fall con cdigo 2. ... error TS2307: Cannot find module './modules/global-search/global-search.routes.js' ... Cannot find module '../movements/categories.service.js' ..."}
```
