...
1. El ecosistema no arranc mediante el script headless autoritativo (fallo en backend build).
2. El frontend no pasa `typecheck` (EXIT=2) por componentes faltantes en `src/components/finance/search/`.
