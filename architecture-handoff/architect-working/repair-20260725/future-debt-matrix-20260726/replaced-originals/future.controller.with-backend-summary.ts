...
import { normalizeFutureDebtView } from "./helpers/future-view-normalization.js";
...
> = async (app: FastifyInstance, options) => {
  ...
  app.get("/", async (request, reply) => {
    ...
    const resolvedResponse = resolveRecognizableCardReferences(rawResponse);
    const response = normalizeFutureDebtView(resolvedResponse, query.from);
