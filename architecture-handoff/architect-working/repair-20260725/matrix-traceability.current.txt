...
export function toTraceability(occurrence: FutureOccurrence): FutureDebtRow {
  ...
  if (occurrence.installmentCurrent === null || occurrence.installmentTotal === null) {
...
export function toPendingTraceability(occurrence: PendingOccurrence): FuturePendingRow {
  let currency: "ARS" | "USD" | null = isSupportedCurrency(occurrence.currencyOriginal)
  ...
  return {
    ...
    installmentNumber: occurrence.installmentCurrent,
    installmentTotal: occurrence.installmentTotal,
    installmentLabel: occurrence.installmentCurrent !== null && occurrence.installmentTotal !== null
