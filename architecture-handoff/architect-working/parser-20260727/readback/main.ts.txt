...
import {
  installAiUnrestrictedExecutionPolicy,
} from "./modules/ai/ai-unrestricted-execution-policy.js";
import {
    ...
    logger.info(
      {
        ...
        providerTimeoutDisabled:
          env.AI_PROVIDER === "ollama"
            ? env.OLLAMA_TIMEOUT_MS === 0
            : env.AI_TIMEOUT_MS === 0,
        jobTimeoutDisabled: aiJobTimeoutDisabled,
        modelContextLimitSent: env.OLLAMA_NUM_CTX > 0,
        modelOutputLimitSent: env.AI_MAX_OUTPUT_TOKENS !== undefined,
      },
