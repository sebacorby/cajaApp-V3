  ...
  return (
    <section className="space-y-6" data-testid="reconciliation-section">
      ...
      <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-5">
        <CountSummaryCard label="Pendientes" value={summary.open} icon={CircleDot} testId="reconciliation-summary-open" />
        <CountSummaryCard label="Resueltas" value={summary.resolved} icon={CheckCircle2} testId="reconciliation-summary-resolved" />
        <CountSummaryCard label="Descartadas" value={summary.dismissed} icon={XCircle} testId="reconciliation-summary-dismissed" />
        <CountSummaryCard label="Relaciones" value={summary.relations} icon={Link2} testId="reconciliation-summary-relations" />
        <CountSummaryCard label="Exclusiones" value={summary.excluded} icon={ShieldCheck} testId="reconciliation-summary-excluded" />
      </div>
