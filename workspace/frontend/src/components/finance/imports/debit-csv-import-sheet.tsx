    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="w-full overflow-y-auto sm:max-w-6xl">
        ...
        <div className="mt-6 space-y-6">
          ...
          {errorMessage ? (
            <div className="flex gap-2 rounded-lg border border-rose-200 bg-rose-50 p-3 text-sm text-rose-800 dark:border-rose-900 dark:bg-rose-950/30 dark:text-rose-300">
          ...
          {message ? (
            <div className="flex gap-2 rounded-lg border border-emerald-200 bg-emerald-50 p-3 text-sm text-emerald-800 dark:border-emerald-900 dark:bg-emerald-950/30 dark:text-emerald-300">
            ...
            <section className="space-y-4" data-testid="debit-csv-preview">
              <div className="flex flex-col gap-3 rounded-xl border p-4 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="flex flex-wrap gap-2 text-sm">
                  <span className="rounded-full bg-emerald-100 px-3 py-1 text-emerald-800 dark:bg-emerald-950/30 dark:text-emerald-300">
                    {selectedRows.length} seleccionadas
                  </span>
                  <span className="rounded-full bg-amber-100 px-3 py-1 text-amber-800 dark:bg-amber-950/30 dark:text-amber-300">
                    {preview.rows.filter((row) => row.duplicateExisting).length} duplicadas
                  </span>
                  <span className="rounded-full bg-rose-100 px-3 py-1 text-rose-800 dark:bg-rose-950/30 dark:text-rose-300">
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="p-2">
                            ...
                            {row.validationError ? (
                              <p className="mt-1 max-w-52 text-xs text-rose-700 dark:text-rose-400">
                                {row.validationError}
                              </p>
                            ) : null}
                          </td>
