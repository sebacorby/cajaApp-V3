    ...
    >
      ...
      <div className="mt-3 space-y-1.5">
        {unclassified > 0 ? (
          ...
          >
            <CircleHelp className="size-4 shrink-0 text-amber-700 dark:text-amber-400" aria-hidden="true" />
        ...
        {alerts > 0 ? (
          <button
            ...
            data-count={alerts}
          >
            <BellRing className="size-4 shrink-0 text-rose-600 dark:text-rose-400" aria-hidden="true" />
            <span className="min-w-0 flex-1">
        ...
        {lastUpdatedAt ? (
          ...
          >
            <Clock3 className="size-4 shrink-0 text-blue-600 dark:text-blue-400" aria-hidden="true" />
            <span className="min-w-0 flex-1">
