...
command = "powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -File """ & launcherPath & """ -Action Start"
exitCode = shell.Run(command, 0, True)

If exitCode <> 0 Then
    MsgBox "CajaApp no pudo iniciarse." & vbCrLf & vbCrLf & _
